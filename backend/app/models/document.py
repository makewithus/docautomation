...
#     # 2. Phir usme values add karo — YEH HI WOH LINE HAI JO INVOICE NUMBER SET KARTI HAI
...
#     # 3. Phir HTML generate karo (ab content mein invoice_number already set hai)
